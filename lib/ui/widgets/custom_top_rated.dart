...
class CustomTopRatedWidget extends StatelessWidget {
  final Responsive responsive;
  final HomeController controller;
  const CustomTopRatedWidget({
      ...
      () {
        return SizedBox(
          ...
          child: ListView.builder(
            ...
            itemCount: controller.initialTopRatedMovies.length,
            itemBuilder: (BuildContext context, int index) {  
              Movie movie = controller.initialTopRatedMovies[index]; 
